'''
All Class methods and class names is taken from boutique ado project
https://github.com/Code-Institute-Solutions/boutique_ado_v1/blob/
250e2c2b8e43cccb56b4721cd8a8bd4de6686546/checkout/models.py
'''
import uuid
...
class Order(models.Model):
    ...
    def new_total(self):
        ...
        self.total = self.lineitems.\
            aggregate(Sum('order_item_total'))['order_item_total__sum'] or 0
        self.save()
...
class Order_item(models.Model):
    ...
    order_item_total = models.DecimalField(max_digits=10,
